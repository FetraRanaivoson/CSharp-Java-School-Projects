...
{
    public partial class SignUpWindow : Window, IPasswordAccessor
    {
        /// <remarks>
        ...
        public SignUpWindow(SignUpViewModel viewModel)
        {
            ...
            // Add handler method to view model's SignUpAttempted event
        ...
        /// the view model's SignUpAttempted event.
        /// </summary>
