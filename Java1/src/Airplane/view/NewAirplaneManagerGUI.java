...
public class NewAirplaneManagerGUI extends JFrame {
    ...
    public void createComponents()
    {
        ...
        createNewAirplaneBtn.addActionListener(e -> {
            ...
            airplaneGUIv2.setTitle("Airplane Controller" + "(" + getAirplaneName(fileManager) + ")");

            //Revert the airplane to its default state
            try {
                setDefaultAirplaneState(0.0);
            } catch (AirplaneAlreadyGroundedException airplaneAlreadyGroundedException) {
                airplaneAlreadyGroundedException.printStackTrace();
            }
    ...
    public void setDefaultAirplaneState(Double altitude) throws AirplaneAlreadyGroundedException //Will notify AirplaneGuiV2 (listener) to change their altitude to 0 and stop the motor
    {
        this.defaultAltitude = altitude;
        airplaneGUIv2.setAltitudeToDefault(defaultAltitude); // airplaneGuiV2 (listener) method
        airplaneGUIv2.setMotorOff(); // airplaneGuiV2 (listener) method
    }
}
